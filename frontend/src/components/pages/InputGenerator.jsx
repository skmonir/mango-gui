...
export default function InputGenerator({ config, appData }) {
  ...
  const getConfigAlert = () => {
    if (inputGenerateRequest.isForParsedProblem && !config.workspaceDirectory) {
      return (
        <Row>
          <Col>
            ...
            <Col xs={12} className="d-grid gap-2">
              <Button
                ...
                disabled={
                  ...
                  (inputGenerateRequest.isForParsedProblem &&
